...
namespace Lab1.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            // Спрощена копія для сесії, без циклів
            var simpleMovie = new
            {
                movie.Id,
                movie.Title,
            ...
            HttpContext.Session.SetString("EditingMovie", JsonSerializer.Serialize(simpleMovie));
        ...
        public async Task<IActionResult> Edit(int id, MovieEditViewModel viewModel)
        {
            ...
            try
            {
                ...
                HttpContext.Session.Remove("EditingMovie");
            }
